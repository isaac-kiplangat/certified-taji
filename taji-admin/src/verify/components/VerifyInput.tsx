...
const VerifyInput = () => {
  ...
  const handleSubmit = ( e: { preventDefault: () => void; } ) => {
    e.preventDefault()
    axios.post( 'http://localhost:3001/', { certNo, authkey } )
      .then( result => {
        console.log( result )
              ...
              <form onSubmit={handleSubmit} >
                ...
                <div className="mx-4 w-[60%]">
                  ...
                  <button
                    type="submit"
                    value="verify"
                    className="w-1/4 text-2xl cursor-pointer rounded-lg border border-primary bg-primary p-4 
                    text-white transition hover:bg-opacity-90">Verify</button>
