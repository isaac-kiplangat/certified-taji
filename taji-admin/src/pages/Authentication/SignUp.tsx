...
const SignUp = () => {
  ...
  const handleSubmit = ( e: { preventDefault: () => void; } ) => {
    e.preventDefault()
    axios.post( 'http://localhost:3009/register', { name, email, password: password } )
      .then( ( result: any ) => {
        console.log( result )
  ...
  return (
    <>
      <div className="rounded-sm border h-screen overflow-y-scroll no-scrollbar border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <NavLink
                ...
                to="/signup"
              >
                <img src={LogoDark} width={200} height={150} alt="Logo" />
              </NavLink>
              <p className=" text-primary">
                Digitizing your Cetificates, easy, simple and secure{' '}
              </p>
